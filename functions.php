...
if ( ! function_exists( 'elegance_setup' ) ) :
	...
	function elegance_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'elegance' ),
		) );
...
function elegance_scripts() {
	...
	wp_enqueue_script( 'elegance-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'elegance-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
